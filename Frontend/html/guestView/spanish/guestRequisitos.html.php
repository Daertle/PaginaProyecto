        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="../spanish/guestIndex.html.php">Español</a></li>
              <li><a class="dropdown-item" href="../english/guestIndex">Inglés</a></li>
              <li><a class="dropdown-item" href="../arabe/guestIndex">Árabe</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="../../guestView/spanish/guestPerfil.html.php">Perfil</a></li>
            </ul>
          </li>
        </ul>
      </div>
          ...
          <div class="card-body">
            <table>
              <tr>
                ...
                <td>
                  <h3 class="card-title">
                    <center>COMPROBANTE DE PAGO</center>
                  </h3>
                </td>
              </tr>
            </table>
          ...
          <div class="card-body">
            <table>
              <tr>
                ...
                <td>
                  <h3 class="card-title">
                    <center>PAGO POR REDPAGOS O ABITAB</center>
                  </h3>
                </td>
              </tr>
            </table>
