      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            ...
            <li><a href="ownerAdministradores.html.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-database-lock" viewBox="0 0 16 16">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="credential-row">
          ...
          <div class="credential-value" id="nombreValue"><?php echo $datosUsuario['nombre']; ?></div>
        ...
        <div class="credential-row">
          ...
          <div class="credential-value" id="apellidoValue"><?php echo $datosUsuario['apellido']; ?></div>
          <div class="edit-buttons">
        ...
        <div class="credential-row">
          ...
          <div class="credential-value" id="emailValue"><?php echo $datosUsuario['correo']; ?></div>
          <div class="edit-buttons">
        ...
        <div class="credential-row">
          ...
          <div class="credential-value" id="telefonoValue"><?php echo $datosUsuario['telefono']; ?></div>
          <div class="edit-buttons">
