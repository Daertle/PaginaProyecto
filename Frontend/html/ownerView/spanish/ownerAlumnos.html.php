  ...
  <nav id="sidebar" class="close">
    <ul>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <div>
            <li class="active"><a href="ownerAlumnos.html.php"><svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <li><a href="ownerAdministradores.html.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form>
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="txtNuevoDocumento"
                            ...
                            <div class="form-group">
                              ...
                              <input type="email" class="form-control" id="txtNuevoCorreo"
                                placeholder="Correo electrónico">
                            </div><br>
                            <div class="form-group">
                              <label for="txtNuevaPassword">Contraseña</label>
                              <input type="password" class="form-control" id="txtNuevaPassword"
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-dismiss="modal"
                            onclick="cerrarModalAgregar()">Cerrar</button>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="form-group">
                    <select id="txtDato" name="txtDato" class="form-control" onchange="mostrarCampoTexto();">
