    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        ...
        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
          ...
          <a href="adminContacto.html.php" class="btn btn-info">Más Información</a>
        </div>
      </div>
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
          ...
          <a href="adminContacto.html" class="btn btn-info">Más Información</a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="footer-content">
        <ul class="ul1">
          ...
          <li class="li1"><a class="a1" href="#"><i class="fab fa-adminagram" aria-hidden="true"></i></a></li>
        ...
        <div class="footer-abajo">
          ...
          <a href="adminIndex.html.php" class="footer-logo">
            <img src="../../../img/logo.png" alt="Logo" width="200" height="67">
          </a>
          <a href="adminContacto.html.php" class="footer-link">Contactanos</a>
        </div>
      </div>z
    </div>
  </footer>
